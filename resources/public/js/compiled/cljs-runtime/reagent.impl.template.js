...
return (function() { 
var G__50776__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__50776 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__50777__i = 0, G__50777__a = new Array(arguments.length -  0);
while (G__50777__i < G__50777__a.length) {G__50777__a[G__50777__i] = arguments[G__50777__i + 0]; ++G__50777__i;}
  args = new cljs.core.IndexedSeq(G__50777__a,0,null);
} 
return G__50776__delegate.call(this,args);};
G__50776.cljs$lang$maxFixedArity = 0;
G__50776.cljs$lang$applyTo = (function (arglist__50778){
var args = cljs.core.seq(arglist__50778);
return G__50776__delegate(args);
});
...
var G__50731 = o;
(G__50731[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__50779__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__50779 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__50780__i = 0, G__50780__a = new Array(arguments.length -  0);
while (G__50780__i < G__50780__a.length) {G__50780__a[G__50780__i] = arguments[G__50780__i + 0]; ++G__50780__i;}
  args = new cljs.core.IndexedSeq(G__50780__a,0,null);
} 
return G__50779__delegate.call(this,args);};
G__50779.cljs$lang$maxFixedArity = 0;
G__50779.cljs$lang$applyTo = (function (arglist__50781){
var args = cljs.core.seq(arglist__50781);
return G__50779__delegate(args);
});
G__50779.cljs$core$IFn$_invoke$arity$variadic = G__50779__delegate;
return G__50779;
})()
;
} else {
...
var G__50741 = props;
var G__50741__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50741,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__50741);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50741__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__50742){
...
var props = map__50743__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50743__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__50743,map__50743__$1,props,class$){
return (function (c){
...
});})(map__50743,map__50743__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__50745){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50746__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__50746,map__50746__$1,on_write){
return (function (){
...
});})(node_value,map__50746,map__50746__$1,on_write))
);
} else {
...
var G__50749 = jsprops;
(G__50749["defaultValue"] = value);

(G__50749["onChange"] = ((function (G__50749,v,value,on_change){
return (function (p1__50748_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__50748_SHARP_);
});})(G__50749,v,value,on_change))
);
...
var vec__50751 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50751,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50751,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50751,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___50805 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___50805 == null)){
} else {
var key_50806 = temp__5739__auto___50805;
(jsprops["key"] = key_50806);
}
...
var temp__5739__auto___50815 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___50815 == null)){
} else {
var key_50820 = temp__5739__auto___50815;
reagent.impl.template.oset(jsprops,"key",key_50820);
}
...
var G__50755 = reagent.impl.template.__GT_NativeWrapper();
(G__50755["name"] = c);
...
var G__50756 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__50756) : reagent.impl.template.as_element.call(null,G__50756));
} else {
...
var i__4731__auto___50828 = (0);
while(true){
if((i__4731__auto___50828 < len__4730__auto___50827)){
args__4736__auto__.push((arguments[i__4731__auto___50828]));

var G__50829 = (i__4731__auto___50828 + (1));
i__4731__auto___50828 = G__50829;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq50759){
...
break;
default:
var G__50839 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__50839;
continue;
...
var n__4607__auto___50847 = a.length;
var i_50848 = (0);
while(true){
if((i_50848 < n__4607__auto___50847)){
(a[i_50848] = reagent.impl.template.as_element((a[i_50848])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___50850 = a.length;
var i_50851 = (0);
while(true){
if((i_50851 < n__4607__auto___50850)){
var val_50852 = (a[i_50851]);
if(((cljs.core.vector_QMARK_(val_50852)) && ((reagent.impl.template.key_from_vec(val_50852) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_50851] = reagent.impl.template.as_element(val_50852));

var G__50853 = (i_50851 + (1));
i_50851 = G__50853;
continue;
} else {
}
...
var ctx = ({});
var vec__50766 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50766,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50766,(1),null);
...
var G__50772 = (cljs.core.count(argv) - first_child);
switch (G__50772) {
case (0):
...
case (1):
var G__50773 = comp;
var G__50774 = jsprops;
var G__50775 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__50773,G__50774,G__50775);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__50772){

...
var o__39597__auto___41898 = (function (){var o__39597__auto__ = (function (){var o__39597__auto__ = Promise;
return (o__39597__auto__["resolve"]).call(o__39597__auto__);
})();
return (o__39597__auto__["then"]).call(o__39597__auto__,callback);
})();
(o__39597__auto___41898["catch"]).call(o__39597__auto___41898,devtools.async.rethrow_outside_promise);
...
var G__41879_41900 = Error;
var target__39604__auto___41901 = G__41879_41900;
if(cljs.core.truth_(target__39604__auto___41901)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41879_41900)].join(''),"\n","target__39604__auto__"].join('')));
}

(target__39604__auto___41901["stackTraceLimit"] = Infinity);

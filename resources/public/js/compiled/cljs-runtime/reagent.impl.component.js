...
if((i < len)){
var k = (ks[i]);
var G__50696 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__50697 = (i + (1));
m = G__50696;
i = G__50697;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__50605 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__50605);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__50611 = c;
var G__50611__$1 = (((G__50611 == null))?null:G__50611.prototype);
if((G__50611__$1 == null)){
return null;
} else {
return (G__50611__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__50613 = c;
var G__50613__$1 = (((G__50613 == null))?null:G__50613.prototype);
if((G__50613__$1 == null)){
return null;
} else {
return (G__50613__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__50721__delegate = function (args){
var G__50621 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__50621) : reagent.impl.component.as_element.call(null,G__50621));
};
...
return G__50721__delegate.call(this,args);};
G__50721.cljs$lang$maxFixedArity = 0;
G__50721.cljs$lang$applyTo = (function (arglist__50724){
var args = cljs.core.seq(arglist__50724);
return G__50721__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__50622 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__50623 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__50623;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__50622;
}});
...
return ((function (G__50630,G__50630__$1){
...
var c = this;
var G__50640_50728 = (c["cljsRatom"]);
if((G__50640_50728 == null)){
} else {
reagent.ratom.dispose_BANG_(G__50640_50728);
}
...
var renders_50729 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_50730 = cljs.core.first(cljs.core.vals(renders_50729));
if((cljs.core.count(renders_50729) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_50729))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_50730)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_50730], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__50641 = name;
switch (G__50641) {
case "":
...
var G__50643 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__50643);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__50644 = fiber;
var G__50644__$1 = (((G__50644 == null))?null:(G__50644["type"]));
if((G__50644__$1 == null)){
return null;
} else {
return (G__50644__$1["displayName"]);
}
})();
var parent = (function (){var G__50645 = fiber;
if((G__50645 == null)){
return null;
} else {
return (G__50645["return"]);
}
})();
var path = (function (){var G__50646 = parent;
var G__50646__$1 = (((G__50646 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__50646) : reagent.impl.component.fiber_component_path.call(null,G__50646)));
if((G__50646__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50646__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4131__auto__ = (function (){var G__50648 = c;
if((G__50648 == null)){
return null;
} else {
return (G__50648["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__50649._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__50651 = c;
if((G__50651 == null)){
return null;
} else {
return (G__50651["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__50653 = c;
if((G__50653 == null)){
return null;
} else {
return G__50653._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__50655 = instance;
if((G__50655 == null)){
return null;
} else {
return (G__50655["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__50656 = instance;
if((G__50656 == null)){
return null;
} else {
return G__50656._currentElement;
}
}
})();
var name = (function (){var G__50657 = elem;
var G__50657__$1 = (((G__50657 == null))?null:(G__50657["type"]));
if((G__50657__$1 == null)){
return null;
} else {
return (G__50657__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__50659 = elem;
if((G__50659 == null)){
return null;
} else {
return (G__50659["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__50660._owner;
}
}
})();
var path = (function (){var G__50661 = owner;
var G__50661__$1 = (((G__50661 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__50661) : reagent.impl.component.component_path.call(null,G__50661)));
if((G__50661__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50661__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__50662 = c;
var G__50662__$1 = (((G__50662 == null))?null:G__50662.constructor);
if((G__50662__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__50662__$1);
}
}
})();

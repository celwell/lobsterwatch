...
var G__39839 = cljs.core.PersistentArrayMap.EMPTY;
var G__39840 = native_stack_trace;
var G__39841 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__39842 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__39839,G__39840,G__39841,G__39842) : cljs.stacktrace.parse_stacktrace.call(null,G__39839,G__39840,G__39841,G__39842));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39850__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39850__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__39850__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e39849){var _e = e39849;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___39903 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___39903)){
var seen_errors_39904 = temp__5733__auto___39903;
if(cljs.core.truth_(seen_errors_39904.has(self))){
} else {
seen_errors_39904.add(self);

var temp__5735__auto___39905 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___39905)){
var sense_39906 = temp__5735__auto___39905;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_39906)].join('');
} else {
}
}
} else {
